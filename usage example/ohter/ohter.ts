...
type GetObjectKeysString<T, U = FilterByValType<T, false>> = T extends Record<
  string,
  any
>
...
type array = ToStringByStrOrNumTuple<
  ['a', 'b', 'c', 1, 2, 3, false, undefined, null, symbol]
>;
...
// 合并返回值
type ClassNames<
  P extends ArrayLike<unknown>,
  Result extends string = '',
> = P extends [infer Args, ...infer Rest]
